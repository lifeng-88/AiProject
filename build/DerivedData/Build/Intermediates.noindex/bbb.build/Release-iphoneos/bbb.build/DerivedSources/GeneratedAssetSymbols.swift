...
extension ImageResource {
    ...
    static let uploadTipsBad = ImageResource(name: "UploadTipsBad", bundle: resourceBundle)

    /// The "UploadTipsGood" asset catalog image resource.
    static let uploadTipsGood = ImageResource(name: "UploadTipsGood", bundle: resourceBundle)
